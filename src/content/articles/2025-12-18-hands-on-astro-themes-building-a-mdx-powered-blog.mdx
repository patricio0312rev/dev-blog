...
![Site architecture diagram showing Astro folder structure and MDX content flow](https://example.com/site-architecture-astro-mdx.png)

![Live preview screenshot of Astro MDX blog post with React Counter component embedded](https://example.com/astro-mdx-counter-preview.png)
