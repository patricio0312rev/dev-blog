...
![Diagram comparing bug-catching before and after enabling strict typing](https://example.com/strict-typing-bug-comparison.png)  
*Before strict typing: bugs slip to runtime; after: caught at compile time and fixed early.*
