...
description: "A practical guide to crafting a scalable Node.js REST API using TypeScript, best architecture, and error handling that won’t make you cry."
category: "tutorial"
...
heroImage: "https://images.unsplash.com/photo-1650234083180-4b965afac328?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4NDc5MDV8MHwxfHNlYXJjaHwyfHxub2RlanMlMjBzZXJ2ZXIlMjBjb2RlfGVufDF8MHx8fDE3Njg3MDU5MDZ8MA&ixlib=rb-4.1.0&q=80&w=1080"
heroImageAlt: "Hero image for article about Building a Rocket-Fuel Node.js API with TypeScript - Step by Step"
# Image by Fili Santillán on Unsplash (https://unsplash.com/@filisantillan)
...
You could use libraries like [Zod](https://zod.dev) or [Yup]. Here’s an example with Zod to validate the request:
