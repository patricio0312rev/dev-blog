...
Search is powered by [Pagefind](https://pagefind.app/) and runs entirely on the client.
...
- UX features:
  ...
  - Recent searches stored in `localStorage` with a “Clear” option
...
| [Pagefind](https://pagefind.app)                         | Static full-text search over generated HTML     |
